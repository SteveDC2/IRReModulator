...
#define INTERVAL_100KHZ_TIMER          TIMER_A
#define INTERVAL_100KHZ_TIMER_PERIPH   SYSCTL_PERIPH_TIMER0
#define INTERVAL_100KHZ_TIMER_BASE     TIMER0_BASE
#define INTERVAL_100KHZ_TIMER_CFG      TIMER_CFG_PERIODIC
